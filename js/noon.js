...
parse = function (s)
{
    ...
    undense = function (d, s)
    {
        ...
        ld = ''
        for (var _74_18_ = i = 0, _74_22_ = d; (_74_18_ <= _74_22_ ? i < d : i > d); (_74_18_ <= _74_22_ ? ++i : --i))
        {
            ld += ' '
        }
        ld += l
    ...
    {
        line = lines[i]
        var _332_18_ = inspect(line); d = _332_18_[0]; k = _332_18_[1]; v = _332_18_[2]; e = _332_18_[3]
        ...
        if ((k != null))
        {
            if ((v != null) && (!e) && (v.substr(0,2) === '. '))
            {
                ...
                for (var _340_22_ = 0; _340_22_ < list.length; _340_22_++)
                {
                    e = list[_340_22_]
                    var _341_31_ = inspect(e); dd = _341_31_[0]; dk = _341_31_[1]; dv = _341_31_[2]
...
stringify = function (obj, options = {})
{
    ...
    pretty = function (o, ind, visited)
    {
        ...
        if (opt.sort)
        {
            ...
            for (var _509_18_ = 0; _509_18_ < list.length; _509_18_++)
            {
                k = list[_509_18_]
        ...
        switch (t = typeof(o))
        {
            ...
            case 'object':
                ...
                if ((o.constructor != null ? o.constructor.name : undefined) === 'Array')
                {
                    ...
                    s += (function () { var r_547_69_ = []; var list = _k_.list(o); for (var _547_69_ = 0; _547_69_ < list.length; _547_69_++)  { v = list[_547_69_];r_547_69_.push(ind + toStr(v,ind + indstr,true,visited))  } return r_547_69_ }).bind(this)().join('\n')
                }
...
load = function (p, ext, cb)
{
    ...
    if (_k_.isFunc(cb))
    {
        ...
        try
        {
            ...
            {
                console.log('slash readText',p,str)
                if (!_k_.empty(str))
                {
    ...
    {
        console.error('noon.load - no callback!')
    }
}
